...
/**
 * Handles the colour detection behaviour for an NXT robot.
 *
...
public class DetectColour implements Behavior {
  ...
  /**
   * The action required when sensor is located over desired colour.
   */
  private Action onColourAction;
  /**
   * The action required when sensor is located off the desired colour.
   */
  private Action offColourAction;
  /**
   * The action to perform when current action is needed to be suppressed.
   */
  private Action suppressAction;
  /**
   * A boolean used to indicated whether the robot is currently on a colour.
   */
  private boolean onColour;

  /**
   * Construct a DetectColour object.
   *
   * @param light
   *          The reference to the light sensor used.
   * @param colourMin
   *          The minimum colour value to look for.
   * @param colourMax
   *          The maximum colour value to look for.
   * @param onColourAction
   *          The action to take when on colour.
   * @param offColourAction
   *          The action to take when off colour.
   */
  public DetectColour(LightSensor light, int colourMin, int colourMax,
      Action onColourAction, Action offColourAction) {
    this.light = light;
   ...
   *
   * @return A boolean boolean value indicating whether the sensor is currently
   *         over the desired colour.
   */
   ...
   */
  public void action() {
    onColour = !onColour; // we either moved onto colour, or off of colour so
