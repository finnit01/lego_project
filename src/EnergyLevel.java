...
/**
 * Holds the energy level of the NXT-Robot and handles any listeners associated
 * with them.
 *
...
public class EnergyLevel {
  ...
  /**
   * An array of listeners that are associated with the robot's energy level.
   */
  private ArrayList<EnergyLevelListener> listeners;

  /**
   * Constructs the EnergyLevel object and assigns instance variables to the
   * parameters.
   *
   * @param initialEnergyLevel
   *          The energy level at start time.
   */
   ...
   *          The new energy level of the robot.
   */
   ...
   *
   * @param listener
   *          The listener wanted to be added.
   */
